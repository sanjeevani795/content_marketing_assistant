...
from src.core.observability import maybe_wrap_openai, traceable
...
class OpenAIClient:
    def __init__(self, model: str = "gpt-4o-mini"):
        ...
        client = OpenAI(api_key=self.api_key) if (OpenAI and self.api_key) else None
        self.client = maybe_wrap_openai(client)

    @property
    def enabled(self) -> bool:
        return self.client is not None

    @traceable(name="openai_text_generation", run_type="llm")
    ...
    @traceable(name="openai_image_generation", run_type="llm")
